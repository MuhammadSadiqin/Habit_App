...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            val pagerTvTitle: TextView = itemView.findViewById(R.id.pager_tv_title)
            val pagerTvStartTime: TextView = itemView.findViewById(R.id.pager_tv_start_time)
            val pagerTvMinutes: TextView = itemView.findViewById(R.id.pager_tv_minutes)
            val pagerPriorityLevel: ImageView = itemView.findViewById(R.id.pager_priority_level)
